...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddressScript, extraNoncePlaceholder, reward, txMessages, recipients){
    ...
    // ASICBoost support - version rolling mask
    this.versionMask = 0x1fffe000;  // Standard ASICBoost version mask
    this.minVersion = 0x20000000;   // BIP9 minimum version
    this.maxVersion = 0x3FFFFFFF;   // Maximum version for ASICBoost
    ...
    this.serializeHeader = function(merkleRoot, nTime, nonce, version){
        ...
        header.writeUInt32BE(version || rpcData.version, position + 32);
